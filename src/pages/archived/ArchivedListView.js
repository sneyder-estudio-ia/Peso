...
export const renderArchivedListView = (container, navigate) => {
    ...
    deleteHistoryButton.onclick = () => {
        ...
        showConfirmationModal('Borrar Historial Antiguo', 'Esta acción borrará permanentemente todos los registros archivados con más de 30 días de antigüedad. ¿Deseas continuar?', () => {
