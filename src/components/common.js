...
export const createSimpleCard = (title) => {
    const card = document.createElement('div');
    card.className = 'card';
...
export const showIncomeTypeModal = (onSelect) => {
...
export const showExpenseTypeModal = (onSelect) => {
    createTypeSelectionModal(
...
export const showSavingTypeModal = (onSelect) => {
    createTypeSelectionModal(
...
export const showConfirmationModal = (
    ...
    message,
    onConfirm,
    confirmButtonClass = 'btn-expense', // default to red for deletions
